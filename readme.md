...
Αρκεί να κατεβάσετε το αρχείο progress2exams.exe και να το τρέξετε, 
...
Αρκεί να κατεβάσετε το αρχείο progress2exams.app.zip, αποσυμπιέζετε το αρχείο και τρέχετε το αρχείο progress2exams.app, μπορείτε να το καρφιτσώσετε στη μπάρα εφαρμογών
Η εφαρμογή απαιτεί να είστε διδάσκων και συνεπώς να έχετε πρόσβαση στην πλατφόρμα exams και την πλατφόρμα progress
